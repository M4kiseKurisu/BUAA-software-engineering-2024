...
| password | Varchar | 64 |是|否|用户登录密码|
| name|Varchar|64|是|否|用户昵称|
| phonenum|Char|11|否|否|用户联系电话|
| email|Varchar|64|否|否|用户联系邮箱|
| major|Varchar|64|否|否|用户专业|
| graduate_year|Integer|32|否|否|用户毕业年份|
...
| 名称 | 数据类型 | 大小 |是否必填 |是否主键 |功能|
| ------- | ------- | ------- |-------|-------|-------|
| picture_id | Integer | 32 |是|是|图片id|
| location|Varchar|256|是|否|图片位置|
