<template>
    <div class="flex-layout">
        ...
        <!-- 最上方用户头像、名称、签名 -->
        <button style="margin-left: 5%; border: none; background-color: white;" @click="this.toInformationShow(this.poster_id)">
    ...
    <div class="flex-layout" style="margin-top: 10px;">
        <!-- 点赞按钮 -->
        <button class="flex-layout" style="background-color: white; border: none; margin-left: 2%; margin-right: 2%;" @click="favorOperation">
        ...
        <!-- 回复按钮 -->
        <button class="flex-layout" style="background-color: white; border: none; margin-left: 2%; margin-right: 2%;" @click="this.open_input = !this.open_input">
    ...
    <div style="margin-top: 10px; margin-left: 2%; margin-right: 3%; background-color: #f7f8fa; 
        padding-left: 1%; padding-right: 2%; padding-top: 12px; padding-bottom: 12px;" v-if="this.open_input">
        <el-input
            v-model="this.write_comment"
        ...
        <div class="flex-container-end">
            <el-button type="primary" size="small" @click="uploadComment">发送评论</el-button>
        </div>
    </div>
    ...
    <div style="margin-top: 15px; margin-left: 2%; margin-right: 3%; border-radius: 2px;
        ...
        <div class="flex-layout" style="margin-left: 3%;">
            <button style="margin-top: 10px; border: none; background-color: #f7f8fa;" v-if="!this.is_favor" @click="favorOperation">
            ...
            <button style="margin-top: 10px; border: none; background-color: #f7f8fa;" v-else @click="favorOperation">
                <svg t="1714554846788" style="height: 27px; width: 27px;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4166" width="200" height="200"><path d="M516.809433 921.67163S-142.389927 480.534026 144.538823 164.134706c18.112122-19.954032 40.522035-35.712601 65.592485-45.84311C335.278905 67.843709 429.932647 119.417208 478.026981 157.995003c20.568002 16.577196 50.038573 16.577196 70.606576 0C597.648846 118.700909 694.963126 65.797142 823.794544 121.259119c19.851704 8.595583 38.066154 20.670331 53.517737 35.814929C1183.78575 456.691516 516.809433 921.67163 516.809433 921.67163" fill="red" p-id="4167"></path></svg>
            </button>
        ...
        <!-- <div v-for="item in 1"> -->
            <div class="flex-layout" style="width: 100%; margin-bottom: 14px;">
                ...
                <button style="width: 4%; aspect-ratio: 1/1; margin-left: 2%; margin-top: 9px; border: none; background-color: white;"
                    @click="this.toInformationShow(item.writer_id)">
                ...
                <div style="margin-left: 4%;">
                    ...
                    <div style="margin-top: 9px;" class="flex-layout">
                        <div class="reply-username-font-style">{{ item.writer_name }}</div>
                        <button v-if="this.my_id === item.writer_id" style="margin-left: 10px; border: none; background-color: #f7f8fa;" @click="deleteComment(item.comment_id)">
                            <svg t="1714569453159" style="height: 15px; width: 15px; margin-top: 3px;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3570" width="200" height="200"><path d="M959.04 192.256h-35.84V958.72a64 64 0 0 1-63.936 63.872H160.64a63.872 63.872 0 0 1-63.872-63.872V192.256h-31.872a31.872 31.872 0 1 1 0-63.872h223.552V32.64c0-17.664 14.272-31.936 31.936-31.936h383.168c17.664 0 32 14.272 32 32v95.68h223.488a32 32 0 0 1 0 64z m-287.424-127.744h-319.36v63.872h319.36v-63.872z m191.68 191.616v-63.872H160.64v734.592a32 32 0 0 0 32 31.936h638.72a32 32 0 0 0 31.936-32V256.192z m-191.68 143.744h63.936v407.168h-63.936V399.872zM480.064 336H544v470.976h-63.872v-471.04z m-191.616 63.872h63.872v407.168h-63.872V399.872z" fill="#86909c" p-id="3571"></path></svg>
                        </button>
                    </div>
...
export default {
    ...
    mounted() {
        ...
        axios({
            ...
            this.poster_id = result.data.poster_id;  //发帖人id
