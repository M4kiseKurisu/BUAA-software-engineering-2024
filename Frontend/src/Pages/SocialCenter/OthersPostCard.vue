<template>
    <button class="card-css" style="width: 100%; aspect-ratio: 4/7; border: none; background-color: white;" @click="toDetail">
        ...
        <div style="width: 92%; margin-left: 6%; margin-top: 10px; height: 30%;" class="content-font">
            {{ this.content }}    
        </div>
        <div class="flex-container" style="margin-left: 6%; margin-top: 5px;">
            ...
            <div class="user-name-font" style="margin-left: 3%; margin-top: 4px; width: 55%; height: 16px;">{{ this.writer_name }}</div>
            ...
            <div class="user-name-font" style="margin-left: 2%; margin-top: 4px; height: 16px;">{{ this.likes }}</div>
        </div>
    </button>
</template>
