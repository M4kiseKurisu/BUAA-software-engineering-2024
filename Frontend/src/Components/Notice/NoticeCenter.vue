<template>
    ...
    <!-- 上边栏右侧第一个图标负责搜索（未实现） -->
    <div v-if="this.haveNotice === 0" class="notice-circle-bound" @click="centerDialogVisible = true; this.haveNotice = 0;">
    ...
    <div v-if="this.haveNotice === 1" class="notice-circle-bound" @click="centerDialogVisible = true; this.haveNotice = 0;">
        <!-- <img src="../../Images/无通知.png" alt="" v-if="haveNotice == 0">
        <img src="../../Images/有通知.png" alt="" v-if="haveNotice == 1"> -->
