<template>
    ...
    <div class="create_group_container">
        <div style="width: 700px;height: 700px;background-color: white;border: 1px solid #ccc;border-radius: 2%;display: flex;flex-direction: column;">
            ...
            <div style="margin-left: 20px;width: 100%;display: flex;align-items: center;margin-top: 20px;">
                ...
                <el-upload v-model:file-list="this.coverList" :limit="1" :show-file-list="false" :auto-upload="false"
                    action="#">
                    <el-button @click="this.coverList = []"  plain>选择图片</el-button>
                </el-upload>
            </div>
            ...
            <div style="width: 100%;margin-top: auto;height: 140px;display: flex;">
                ...
                <div style="width: 50%;height: 100%;display: flex;align-items: center;justify-content: center;"> 
                    <el-button type = "primary" plain>发布团体</el-button>
                </div>
            </div>
