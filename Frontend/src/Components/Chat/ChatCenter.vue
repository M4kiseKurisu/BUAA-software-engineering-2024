<template>
    <div class="chatContainer">
        <!-- <div class="aside"> -->
        <div style="width: 27%; height: 100%; background-color: #efefef;">
            <!-- <div class="chatBar">
            ...
            <div style="width: 100%; background-color: #f7f8fa; padding-top: 12px; padding-bottom: 16px;">
                <div style="display: flex; width: 90%; margin-left: 5%; align-items: center; ">
                    <div style="width: 90%;">
                        <el-input v-model="nameKeyWord" style="width: 100%; " placeholder="搜索用户及群聊"
                        clearable />
                    </div>
                    <div>
                        <el-button style="width: 30px; height: 30px; margin-left: 4px; border: none; background-color: #f7f8fa;">
                            <svg t="1715139963488" style="width: 22px; height: 22px; " viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2334" width="200" height="200"><path d="M674.1504 619.9808l1.6896 1.536 235.3152 235.3152a25.6 25.6 0 1 1-36.1984 36.1984l-235.3152-235.3152a26.0608 26.0608 0 0 1-0.2048-0.1536 320 320 0 1 1 9.216-461.4144 25.6 25.6 0 0 1-36.1984 36.1984 268.8 268.8 0 1 0 67.3792 112.5376 25.6 25.6 0 1 1 49.0496-14.6944c10.0864 33.6384 14.592 68.7616 13.312 103.936a318.7712 318.7712 0 0 1-68.0448 185.856z" fill="#86909c" p-id="2335"></path></svg>
                        </el-button>
                    </div>
                </div>
                ...
                <div style="width: 90%; margin-left: 5%; margin-top: 16px; display: flex;">
                    <div style="width: 50% ; display: flex; justify-content: center;align-items: center;">
                        <button style="width: 26px; height: 26px; border: none; background-color: #f7f8fa;">
                            <svg t="1715140629455" style="width: 100%; height: 100%" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4751" width="200" height="200"><path d="M345.571015 461.585797c-27.467585 0-49.694819 22.226211-49.694819 49.694819 0 27.432793 22.227234 49.694819 49.694819 49.694819 27.465538 0 49.690726-22.26305 49.690726-49.694819 0-27.469632-22.225187-49.694819-49.690726-49.694819zM511.216659 461.585797c-27.467585 0-49.694819 22.25691-49.694819 49.694819 0 27.432793 22.228257 49.694819 49.694819 49.694819 27.468608 0 49.690726-22.26305 49.690726-49.694819 0-27.437909-22.222117-49.694819-49.690726-49.694819zM676.86128 461.585797c-27.468608 0-49.694819 22.226211-49.694819 49.694819 0 27.432793 22.226211 49.694819 49.694819 49.694819s49.694819-22.26305 49.694819-49.694819c0.001023-27.469632-22.226211-49.694819-49.694819-49.694819z" fill="#86909c" p-id="4752"></path><path d="M878.772896 765.278517c52.185546-75.1864 79.684854-162.667823 79.684854-254.0286 0-246.626004-200.615087-447.245184-447.241091-447.245184S63.972499 264.654612 63.972499 511.279592c0 246.558465 200.61918 447.208345 447.245183 447.246208 71.855538 0 142.997831-17.569144 206.701713-50.894134l164.76867 49.469691a33.371038 33.371038 0 0 0 9.57917 1.410116c8.66638 0 17.066701-3.41068 23.35594-9.725502a33.148981 33.148981 0 0 0 8.31641-32.93511l-45.166689-150.572344z m-146.141428 93.349062a51.166333 51.166333 0 0 0-38.430264 3.667529c-56.356542 29.482475-119.632681 45.065382-182.977382 45.065382-218.403219-0.032746-396.087037-177.713494-396.087037-396.080898 0-218.415498 177.680748-396.10955 396.079874-396.109549 218.397079 0 396.075781 177.680748 396.075781 396.079874 0 40.241516-6.031367 79.861886-17.925255 117.757984-11.888771 37.880749-29.595039 73.912383-52.627614 107.096156a51.16531 51.16531 0 0 0-6.974855 43.875277l35.539424 118.480438-132.672672-39.832193z" fill="#86909c" p-id="4753"></path></svg>
                        </button>
                    </div>
        ...
        <div style="width: 73%; height: 100%; background-color: #f7f8fa;">
            <div style="height: 10%; width: 100%; display: flex; align-items: center;">
                <div v-if="this.chatKindChose == 1" style="font-size: 25px; margin-left: 5%;">
                    {{ personName }}
                </div>
            </div>
            <el-divider />
            ...
            <div style="height: 29%; width: 100%;">
                <textarea placeholder="输入聊天内容" style="width: 95%; margin-left: 2%; margin-top: 20px; height: 64%;
